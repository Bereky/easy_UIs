...
const Nav = () => {
    ...
    return ( 
        <nav class={`relative h-20 flex justify-between flex-row shadow w-full ${theme.darkMode && 'bg-darkModeBody'} `}>
            <div class="flex flex-row h-full px-8 my-auto items-center" data-aos="flip-up" data-aos-duration="1000">
            ...
            <div class="flex flex-row items-center space-x-3 justify-end pr-10" data-aos="flip-up" data-aos-duration="1000">
