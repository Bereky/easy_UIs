...
const Cards = () => {
    return ( 
        <div className="flex flex-row flex-wrap items-center justify-center my-8 m-1 space-x-4 space-y-4" >
            <div className="h-96 w-72 shadow-2xl rounded-lg flex flex-col hover:shadow-sm transition ease-in-out duration-500 mt-4">
                ...
                <div className="flex flex-col items-center mx-3 my-2 cursor-default">
            ...
            <div className="h-96 w-72 shadow-2xl rounded-lg flex flex-col hover:shadow-sm transition ease-in-out duration-500">
                <div className="flex items-center justify-center py-3">
